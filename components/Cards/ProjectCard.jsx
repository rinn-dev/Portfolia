...
const ProjectCard = ({ data }) => {
  return (
    <a href={data.url} rel="noreferrer" target="_blank" className="group w-full max-w-[450px] md:max-w-none md:w-[325px] lg:w-[420px] xl:w-[380px] 2xl:w-[530px] h-[250px] 2xl:h-[300px] mx-auto md:mx-0 lg:mx-auto block">
